...
function generateTestData(config) {    
    ...
    /* if(!bookingPage.Panel(0).Panel(6).Exists)
    {
      aqUtils.Delay(20000);
    }    */
    ...
    flightSelectSection.Panel(0).Panel(6).Panel(0).Panel(0).Panel(0).Panel(1).Panel(0).Panel(0).Panel(0).Panel(0).Panel(2).Panel(0).Panel(0).Click();
    flightSelectSection.Panel(0).Panel(6).Panel(0).Panel(0).Panel(0).Panel(1).Panel(0).Panel(0).Panel(0).Panel(2).Panel(0).Panel(0).Panel(0).Panel(2).Panel(0).Panel(0).Click();
    ...
    bookingObject.flightNum = flightNum;
